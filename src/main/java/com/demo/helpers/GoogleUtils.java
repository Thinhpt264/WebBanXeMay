...
public class GoogleUtils {
	private final static String GOOGLE_CLIENT_ID = "885278340721-us6jlocdo6p1ql45ml84h1f1ikmbmj1v.apps.googleusercontent.com";
	private final static String GOOGLE_CLIENT_SECRET = "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";
	private final static String GOOGLE_REDIRECT_URI = "http://localhost:8080/Cua_hang_xe_may/login-google";
